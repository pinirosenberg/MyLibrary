...
namespace MyLibrary.Controllers
{
    public class ShelvesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Width,Height,LeftWidth, genreName")] Shelf shelf)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Width,Height,LeftWidth")] Shelf shelf)
        {
            if (id != shelf.Id)
            {
                return NotFound();
